...
#### Vemögensentwicklung unterteilt auf die Einkommensgruppen[^77]

[^77]: Erstellt von Aaron Studer
...
### Verteilung der Konten auf die Kunden[^78]
...
#### Spalte Sparkonto (is_savings_account)[^81]

[^81]: Erstellt von Aaron Studer
...
#### Spalte Darlehenskonto (is_loan_account)[^82]
...
#### Vermögensentwicklung bei Konten mit hohem Eikommen[^83]
...
#### Altesverteilung der Kontoinhaber aufgeteilt auf den Einkommensklassen[^84]
...
### Bargeldbezüge ohne Angabe des Verwendungszwecks[^85]
...
#### Varialbelbeschreibung (Levels)[^86]
...
#### Bargeldbezüge über 10'000 CZK[^87]
...
#### Top 3 der höchsten Kreditkartenbezüge[^91]
...
### CrossSelling Produkt Kreditkarte[^92]
...
#### Voraussetzung an Konto/Kunde[^94]
...
#### Kundengruppe Kreditkartenangebote[^96]
...
#### Visualisierung der Kundengruppen "Kreditkartenangebot"[^97]
...
#### Zusammenfassung der Gruppe "Kreditkartenangebote"[^98]
...
#### Art der Kontaktaufnahme mit dieser Kundengruppe[^99]
...
### Entscheidungsbaum Kreditkarten[^101]
...
### Cross-Selling Produkt Umkehrhypothek (HELOC)[^104]
...
#### Liste Kunden für Angebot der Umkehrhypothek[^109]
...
#### Spalte Angebot Umkehrhypothek (heloc_offer)[^110]
...
#### Weitere Cross-Selling Produkte[^111]
...
über die Zeit aus?[^113]

[^113]: Erstellt von Christian Heeb
...
#### Altersverteilung der Kunden[^114]
...
#### Verteilung der Kreditkartentypen [^115]

[^115]: Erstellt von Aaron Studer
...
#### Clustering des Einkommens und der Ausgaben[^116]
...
#### Beliebtester Modus einer Transaktion?[^117]
...
#### Anzahl der Kunden in den einzelnen Distrikten.[^120]
...
#### Durchschnittslohn in den verschiedenen Distrikten[^121]
...
in den verschiedenen Distrikten[^122]

[^122]: Erstellt von Luca Gisler
...
[^124]: Erstellt von Christian Heeb
...
#### Decision Tree und Random Forest Modelle zur Vorhersage der Kreditwürdigkeit[^125]
...
#### Wie sieht das Verhältnis der der Verwendung von verschiedenen Zahlungsmittel in Abhängigkeit der Zeit aus?[^128]
...
#### Analyse der Kundengruppe welche eine Gold-Kreditkarte verwendet[^129]

[^129]: Erstellt von Christian Heeb
...
#### Entwicklung des Einkommens im Bezug zu begangenen Straftaten[^131]

[^131]: Erstellt von Luca Gisler
...
[^132] [^133]: Erstellt von Luca Gisler

[^132]: Erstellt von Luca Gisler

[^133]: Erstellt von Luca Gisler
...
[^134] [^135]: Erstellt von Luca Gisler

[^134]: Erstellt von Luca Gisler

[^135]: Erstellt von Luca Gisler
...
entsprechenden Regionen(Cross Selling)[^136]

[^136]: Erstellt von Luca Gisler
